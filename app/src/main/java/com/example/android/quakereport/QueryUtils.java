    ...
    public static List<earthquake> extractFeatureFromJson(String jsonResponse) {
        ...
        try {
            ...
            for(int i=0; i<features.length(); i++)
            {
                ...
                String location=features.getJSONObject(i).getJSONObject("properties").getString("place");
                ...
                earthquake obj=new earthquake(mag,location,dateToDisplay, timeToDisplay, url);
                earthquakes.add(obj);
            }
